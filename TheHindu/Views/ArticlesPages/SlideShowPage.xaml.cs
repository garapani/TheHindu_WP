...
namespace TheHindu.Views
{
    public partial class SlideShowPage
    {
        ...
        private SlideshowViewModel _articleViewModel;
            ...
            try
            {
                ...
                if (_articleViewModel != null)
                {
                    ...
                    if (e.NavigationMode == NavigationMode.New)
                    {
                        ...
                        if (article != null)
                        {
                            var url = await _articleViewModel.GetPresentSlideAsync(id);
                            try
                            {
                                //this._articleViewModel.Article.HDThumbnail = url;
                                article.HdThumbnail = url;
                            }
                            catch (Exception)
                            {
                            }
        ...
        private void UpdateSecondPivot()
        {
            ...
            if (temp != null)
            {
                ...
                SecondPivotStory.Html = temp.Description;
            }
            ApplicationBar.IsVisible = true;
            FontStyleSelection.Visibility = System.Windows.Visibility.Collapsed;
        }
        ...
        private void UpdateThirdPivot()
        {
            ...
            if (temp != null)
            {
                ...
                ThirdPivotStory.Html = temp.Description;
            }
            ApplicationBar.IsVisible = true;
            FontStyleSelection.Visibility = System.Windows.Visibility.Collapsed;
        }
        ...
        private void previousButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            _articleViewModel.Article.HdThumbnail = _articleViewModel.GetPreviousSlide();
        ...
        {
            this.DataContext = null;
            _articleViewModel.Article.HdThumbnail = _articleViewModel.GetNextSlide();
            this.DataContext = _articleViewModel;
        }
    }
}