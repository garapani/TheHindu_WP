...
{
    public partial class TopStoriesArticlesPage
    {
        #region Fields
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            catch (Exception exception)
            {
                ...
                {
                    Debug.WriteLine("TopStoriesArticlesPage.xaml.cs:" + exception);
                }
            }
        }
        ...
        private void story_HtmlLoaded(object sender, EventArgs e)
        {
            var block = (FixedHtmlTextBlock)sender;
            block.Generators["p"] = new ParagraphGenerator
            {
